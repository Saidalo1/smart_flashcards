...
STRINGS = {
    ...
    'star_tooltip':       {'ru': 'Отметить: хочу изучить',    'uz': "Belgilash: o'rganmoqchiman",         'en': 'Mark: want to study'},
    ...
    'catalog_update':     {'ru': '↻ Обновить',                'uz': '↻ Yangilash',                        'en': '↻ Update'},
    'catalog_uptodate':   {'ru': '✓ Актуально',               'uz': '✓ Yangilangan',                      'en': '✓ Up to date'},
    'catalog_update_all': {'ru': '↻ Обновить всё',            'uz': '↻ Hammasini yangilash',              'en': '↻ Update all'},
    'catalog_all_uptodate':{'ru': 'Все темы уже актуальны.',  'uz': 'Barcha mavzular allaqachon yangilangan.', 'en': 'All topics are already up to date.'},
    'catalog_update_tt':  {'ru': 'Обновить из облака',        'uz': 'Bulutdan yangilash',                 'en': 'Update from cloud'},
    'catalog_updated_toast':{'ru': 'Тема «{name}» обновлена ({n} слов).',
                           'uz': "«{name}» mavzusi yangilandi ({n} so'z).",
                           'en': 'Topic "{name}" updated ({n} words).'},
    'catalog_uptodate_toast':{'ru': 'Тема «{name}» уже актуальна.',
                           'uz': "«{name}» mavzusi allaqachon yangilangan.",
                           'en': 'Topic "{name}" is already up to date.'},
